...
Образ, относящийся к соответствующему git-тэгу или git-ветке будет храниться в Docker Registry в соответствии с [политиками очистки]({{ site.baseurl }}/ru/documentation/reference/cleaning_process.html#политики-очистки).
