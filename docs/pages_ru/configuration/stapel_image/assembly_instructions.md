...
Сигнатура стадии может меняться также из-за использования переменных окружения и Go-шаблонов, — если делать это не продуманно, то можно получить в результате неожиданные пересборки стадий. Например:
