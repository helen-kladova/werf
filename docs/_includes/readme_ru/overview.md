...
* Werf может собирать Docker-образы как используя Dockerfile'ы, так и альтернативный сборщиком с собственным синтаксисом, обладающим большей скоростью. Werf также очищает Docker Registry от мусора (неиспользуемых образов).
